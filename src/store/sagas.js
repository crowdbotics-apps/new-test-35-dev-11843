...
function* api_v1_ghhh_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_ghhh_list, action)
    yield put(actions.api_v1_ghhh_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_ghhh_listFailed(err, action))
  }
}
function* api_v1_ghhh_listWatcher() {
  yield takeEvery(types.API_V1_GHHH_LIST, api_v1_ghhh_listWorker)
}
function* api_v1_ghhh_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_ghhh_create, action)
    yield put(actions.api_v1_ghhh_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_ghhh_createFailed(err, action))
  }
}
function* api_v1_ghhh_createWatcher() {
  yield takeEvery(types.API_V1_GHHH_CREATE, api_v1_ghhh_createWorker)
}
function* api_v1_ghhh_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_ghhh_read, action)
    yield put(actions.api_v1_ghhh_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_ghhh_readFailed(err, action))
  }
}
function* api_v1_ghhh_readWatcher() {
  yield takeEvery(types.API_V1_GHHH_READ, api_v1_ghhh_readWorker)
}
function* api_v1_ghhh_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_ghhh_update, action)
    yield put(actions.api_v1_ghhh_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_ghhh_updateFailed(err, action))
  }
}
function* api_v1_ghhh_updateWatcher() {
  yield takeEvery(types.API_V1_GHHH_UPDATE, api_v1_ghhh_updateWorker)
}
function* api_v1_ghhh_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_ghhh_partial_update, action)
    yield put(actions.api_v1_ghhh_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_ghhh_partial_updateFailed(err, action))
  }
}
function* api_v1_ghhh_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_GHHH_PARTIAL_UPDATE,
    api_v1_ghhh_partial_updateWorker
  )
}
function* api_v1_ghhh_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_ghhh_delete, action)
    yield put(actions.api_v1_ghhh_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_ghhh_deleteFailed(err, action))
  }
}
function* api_v1_ghhh_deleteWatcher() {
  yield takeEvery(types.API_V1_GHHH_DELETE, api_v1_ghhh_deleteWorker)
}
...
function* api_v1_vbg1_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_vbg1_list, action)
    yield put(actions.api_v1_vbg1_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_vbg1_listFailed(err, action))
  }
}
function* api_v1_vbg1_listWatcher() {
  yield takeEvery(types.API_V1_VBG1_LIST, api_v1_vbg1_listWorker)
}
function* api_v1_vbg1_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_vbg1_create, action)
    yield put(actions.api_v1_vbg1_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_vbg1_createFailed(err, action))
  }
}
function* api_v1_vbg1_createWatcher() {
  yield takeEvery(types.API_V1_VBG1_CREATE, api_v1_vbg1_createWorker)
}
function* api_v1_vbg1_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_vbg1_read, action)
    yield put(actions.api_v1_vbg1_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_vbg1_readFailed(err, action))
  }
}
function* api_v1_vbg1_readWatcher() {
  yield takeEvery(types.API_V1_VBG1_READ, api_v1_vbg1_readWorker)
}
function* api_v1_vbg1_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_vbg1_update, action)
    yield put(actions.api_v1_vbg1_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_vbg1_updateFailed(err, action))
  }
}
function* api_v1_vbg1_updateWatcher() {
  yield takeEvery(types.API_V1_VBG1_UPDATE, api_v1_vbg1_updateWorker)
}
function* api_v1_vbg1_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_vbg1_partial_update, action)
    yield put(actions.api_v1_vbg1_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_vbg1_partial_updateFailed(err, action))
  }
}
function* api_v1_vbg1_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_VBG1_PARTIAL_UPDATE,
    api_v1_vbg1_partial_updateWorker
  )
}
function* api_v1_vbg1_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_vbg1_delete, action)
    yield put(actions.api_v1_vbg1_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_vbg1_deleteFailed(err, action))
  }
}
function* api_v1_vbg1_deleteWatcher() {
  yield takeEvery(types.API_V1_VBG1_DELETE, api_v1_vbg1_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    ...
    api_v1_ghhh_listWatcher,
    api_v1_ghhh_createWatcher,
    api_v1_ghhh_readWatcher,
    api_v1_ghhh_updateWatcher,
    api_v1_ghhh_partial_updateWatcher,
    api_v1_ghhh_deleteWatcher,
    ...
    api_v1_vbg1_listWatcher,
    api_v1_vbg1_createWatcher,
    api_v1_vbg1_readWatcher,
    api_v1_vbg1_updateWatcher,
    api_v1_vbg1_partial_updateWatcher,
    api_v1_vbg1_deleteWatcher,
